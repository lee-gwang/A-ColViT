...
from engine import train_one_epoch, train_pruned_one_epoch, validate, validate_pruned
...
def get_args():
    ...
    # pruning
    parser.add_argument('--flops', type=float, default=1, help='pruning flops layers')
    parser.add_argument('--strict', action='store_true', dest='model path, strict')

    # parser.add_argument('--flops2', type=float, default=1, help='pruning flops channel')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_pruned_one_epoch(
